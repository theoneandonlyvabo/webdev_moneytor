        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="group relative">
                    ...
                    <div class="relative bg-white rounded-2xl overflow-hidden shadow-lg h-full flex flex-col">
                        <div class="h-64 overflow-hidden relative">
                            <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=800&q=80" alt="CEO" class="w-full h-full object-cover object-top transform group-hover:scale-110 transition duration-700 ease-out">
                        ...
                        <div class="p-6 flex-1 flex flex-col items-center text-center relative bg-white">
                            ...
                            <p class="text-green-600 font-medium mb-3">Chief Executive Officer</p>
                            <p class="text-gray-500 text-sm">Visioner yang percaya bahwa mengatur uang seharusnya semudah memesan ojek online.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="group relative">
                    ...
                    <div class="relative bg-white rounded-2xl overflow-hidden shadow-lg h-full flex flex-col">
                        <div class="h-64 overflow-hidden relative">
                            <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=800&q=80" alt="CTO" class="w-full h-full object-cover object-top transform group-hover:scale-110 transition duration-700 ease-out">
                            <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4 backdrop-blur-sm">
                                <a href="#" class="p-2 bg-white rounded-full text-gray-900 hover:bg-blue-600 hover:text-white transition transform hover:-translate-y-1"><svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clip-rule="evenodd"/></svg></a>
                        ...
                        <div class="p-6 flex-1 flex flex-col items-center text-center relative bg-white">
                            ...
                            <p class="text-indigo-600 font-medium mb-3">Chief Financial Officer</p>
                            <p class="text-gray-500 text-sm">Arsitek kode di balik Moneytor. Pecinta algoritma efisien dan kopi hitam tanpa gula.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="group relative">
                    ...
                    <div class="relative bg-white rounded-2xl overflow-hidden shadow-lg h-full flex flex-col">
                        <div class="h-64 overflow-hidden relative">
                            <img src="https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=800&q=80" alt="CMO" class="w-full h-full object-cover object-top transform group-hover:scale-110 transition duration-700 ease-out">
                            <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4 backdrop-blur-sm">
                        ...
                        <div class="p-6 flex-1 flex flex-col items-center text-center relative bg-white">
                            ...
                            <p class="text-purple-600 font-medium mb-3">Chief Operation Officer</p>
                            <p class="text-gray-500 text-sm">Memastikan pengalaman pengguna Moneytor semulus mungkin, satu pixel pada satu waktu.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="group relative">
                    ...
                    <div class="relative bg-white rounded-2xl overflow-hidden shadow-lg h-full flex flex-col">
                        <div class="h-64 overflow-hidden relative">
                            <img src="https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=800&q=80" alt="Marketing Lead" class="w-full h-full object-cover object-top transform group-hover:scale-110 transition duration-700 ease-out">
                            <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4 backdrop-blur-sm">
                        ...
                        <div class="p-6 flex-1 flex flex-col items-center text-center relative bg-white">
                            ...
                            <p class="text-orange-600 font-medium mb-3">Chief Technology Offcier</p>
                            <p class="text-gray-500 text-sm">Menyebarkan misi literasi finansial ke seluruh pelosok negeri dengan strategi kreatif.</p>
                        </div>
                    </div>
                </div>
