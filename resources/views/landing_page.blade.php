...
<body class="antialiased bg-gray-50 text-gray-800">
                        ...
                        <div class="p-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="col-span-2 space-y-6">
                                <div class="flex justify-between items-end">
                                    ...
                                    <div class="h-10 w-10 bg-indigo-100 rounded-full"></div>
                                </div>
                                ...
                                <div class="h-48 bg-gray-50 rounded-xl border border-gray-100 flex items-end justify-around p-4 pb-0">
                                    <div class="w-8 bg-indigo-200 rounded-t-lg h-20"></div>
                                    <div class="w-8 bg-indigo-300 rounded-t-lg h-32"></div>
                                    <div class="w-8 bg-indigo-500 rounded-t-lg h-40"></div>
                                    <div class="w-8 bg-indigo-300 rounded-t-lg h-28"></div>
                                    <div class="w-8 bg-indigo-200 rounded-t-lg h-24"></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section id="features" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-indigo-600 font-bold tracking-wide uppercase text-sm">Features</h2>
                <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                    Everything you need to control cash flow
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div class="relative group">
                    <div class="absolute -inset-1 bg-gradient-to-r from-indigo-600 to-blue-600 rounded-2xl blur opacity-25 group-hover:opacity-75 transition duration-1000 group-hover:duration-200"></div>
    ...
    <!-- CTA Section -->
    <section class="bg-indigo-700 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center justify-between">
            <div class="text-center lg:text-left mb-8 lg:mb-0">
                ...
                <p class="mt-4 text-lg text-indigo-200 max-w-xl">
                    Join over 10,000+ users who are saving an average of $300/month with Moneytor.
                </p>
            </div>
            <div class="flex gap-4">
                <a href="#" class="px-8 py-4 bg-white text-indigo-600 font-bold rounded-xl shadow-lg hover:bg-gray-50 transition">
                    Get Started
                </a>
            </div>
        </div>
    ...
    <footer class="bg-gray-900 text-gray-300 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
            <div class="col-span-1 md:col-span-1">
                <div class="flex items-center gap-2 mb-4">
                    <div class="w-6 h-6 bg-indigo-500 rounded flex items-center justify-center text-white text-xs font-bold">M</div>
                    <span class="text-white font-bold text-lg">Moneytor</span>
                </div>
                <p class="text-sm text-gray-400">Making financial freedom accessible to everyone, everywhere.</p>
            </div>
            <div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-8 border-t border-gray-800 text-center text-xs text-gray-500">
            &copy; 2025 Moneytor Inc. All rights reserved.
        </div>
    </footer>
